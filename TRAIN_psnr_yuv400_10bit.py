        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                for test_data in tqdm(test_loader):
                    ...
                    E_img = util.tensor2uint10(visuals['E'])
                    H_img = util.tensor2uint10(visuals['H'])
                    ...
                    save_img_path = os.path.join(img_dir, '{:s}.jpg'.format(img_name))
                    # util.imsave(E_img, save_img_path)

                    # -----------------------
                    # calculate PSNR
                    # -----------------------
                    current_psnr = util.calculate_psnr10(E_img, H_img, border=border)
